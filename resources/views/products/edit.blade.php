    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="mb-5">
                ...
                <h1 class="fw-800 mt-3">Edit Product</h1>
                <p class="text-muted">Modify the details of your inventory item below.</p>
            </div>
                ...
                <div class="card-body">
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0"><i
                                            class="fas fa-dollar-sign small"></i></span>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-600 extra-small text-uppercase text-muted">Stock Level</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0"><i
                                            class="fas fa-boxes small"></i></span>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch bg-light p-3 rounded-3 border">
                                ...
                                <input class="form-check-input ms-0 me-3" type="checkbox" name="enabled" id="enabled"
                                    value="1" {{ old('enabled', $product->enabled) ? 'checked' : '' }}>
                                <label class="form-check-label fw-600" for="enabled">Product is active and visible</label>
                            </div>
                        </div>
